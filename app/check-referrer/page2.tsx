    ...
    return (
        <main className="p-4 pb-10 min-h-[100vh] flex flex-col items-center">
            <div style={{
                ...
                <h1 className="text-center text-[18px] font-bold">ตรวจสอบข้อมูลของท่าน</h1>
                    ...
                    <table className="table-auto border-collapse border border-gray-500 mt-4 w-full">
                        <tbody>
                            <tr>
                                ...
                                <td className="border border-gray-400 px-4 py-2">{matchingUser.userId}</td>
                            </tr>
                            <tr>
                                <td className="border border-gray-400 px-4 py-2">รหัสผู้แนะนำ</td>
                                <td className="border border-gray-400 px-4 py-2">{matchingUser.referrerId}</td>
                            </tr>
                            <tr>
